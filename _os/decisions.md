...
2026-09-22 - Rebuilt the portfolio around scoped $350, $950, and $1,750 website and ads offers, added server-verified Turnstile to public forms, and patched vulnerable dependencies - Clear deliverables and a short inquiry path are conversion hypotheses; real CAPTCHA configuration and production validation remain release gates. See RESEARCH-AND-RELEASE-20260922.md.
2026-09-22 - Added a root documentation index, synchronized the design guide with the new service ladder and form behavior, and labeled the September 8 update historical - Current setup guidance now distinguishes verified local checks from the blocked Cloudflare production activation.
2026-09-22 - Deployed dependency security patches separately through PR #7 - The live site receives known vulnerability fixes while redesign PR #6 waits for real Cloudflare keys, without disabling existing inquiries.
2026-09-22 - Used the uncommitted checkout work, unpublished design, and live site as references for a stronger case study and project-goal prompt - Gstack headless verified three project views, mobile controls, keyboard operation, and video playback/recovery while preserving the user's affordable service ladder and original dirty checkout.
2026-09-22 - Restyled the inquiry confirmation with an explicit sent heading, checkmark, readable next steps, and scoped light colors - The owner confirmed real email delivery but reported that inherited dark styles obscured success.
